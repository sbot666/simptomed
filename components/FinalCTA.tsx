  ...
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30">
        <div className="absolute top-0 left-1/3 w-96 h-96 bg-cyan-400/30 rounded-full blur-3xl animate-pulse-slow" />
      ...
      >
        ...
        <p className="text-lg text-slate-200/90 mb-9 max-w-2xl mx-auto">
        ...
        <div className="flex justify-center">
          <Link
            href="/chat"
            className="group inline-flex items-center gap-2 bg-white hover:bg-slate-100 text-slate-900 font-semibold px-8 py-3.5 rounded-xl transition shadow-2xl shadow-black/20 hover:-translate-y-0.5 duration-200"
          >
            Начать бесплатно
        ...
        <p className="mt-7 text-sm text-slate-300/80">
